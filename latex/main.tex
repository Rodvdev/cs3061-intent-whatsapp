...
delega esta clasificaci\'on a un modelo de lenguaje de gran escala (LLM),
incurriendo en latencia y costo aun para mensajes triviales. Este trabajo
investiga si modelos cl\'asicos de aprendizaje autom\'atico pueden cubrir esa
etapa con calidad equivalente. Como los corpus comerciales no son p\'ublicos,
constru\'imos un corpus sint\'etico multiling\"ue (espa\~nol, ingl\'es y
portugu\'es) de 1\,320 mensajes balanceados sobre doce intenciones can\'onicas,
generado con plantillas, \emph{slot-filling} y ruido superficial. Comparamos
Naive Bayes, $K$-NN, SVM (lineal y RBF), \'Arboles de Decisi\'on, Bosques
Aleatorios y un Perceptr\'on Multicapa contra un baseline de reglas y contra el
baseline LLM. El mejor clasificador cl\'asico alcanza un F1-macro de 0{,}965,
frente a 0{,}973 del LLM, con una latencia cuatro \'ordenes de magnitud menor.
Un sistema h\'ibrido que delega al LLM s\'olo el 3\% de los mensajes iguala su
exactitud ahorrando el 97\% de las llamadas.
\end{abstract}
...
\vspace{4pt}
\noindent\textbf{Repositorio:} \url{https://github.com/<usuario>/cs3061-intent-whatsapp}
\\ \textbf{Nota:} reemplazar por el enlace real del repositorio git o Google Colab.
